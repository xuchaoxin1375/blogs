...
- $E(X)=\frac{a+b}{2};D(X)=\frac{(b-a)^2}{12}$
  ...
  - $$
    ...
    \\
    =\frac{1}{b-a}\int_{a}^{b}xdx=\frac{1}{2}\frac{1}{b-a}x^2|_{a}^{b}
    \\
    =\frac{1}{2}\frac{1}{b-a}(b^2-a^2)
    =\frac{1}{2}\frac{1}{b-a}(b-a)(b+a)
    \\
    =\frac{1}{2}(a+b)
    $$
    ...
    \\
    =\frac{1}{3}\frac{1}{b-a}(b^3-a^3)=\frac{1}{3}\frac{1}{b-a}(b-a)(b^2+ab+a^2)
    \\
    =\frac{1}{3}(a^2+ab+b^2)
    $$
    ...
    \\
    =\frac{1}{12}a^2-\frac{1}{6}ab+\frac{1}{12}b^2
    =\frac{1}{12}(a^2-2ab+b^2)=\frac{1}{12}(a-b)^2
    \\=\frac{(b-a)^2}{12}
    $$
